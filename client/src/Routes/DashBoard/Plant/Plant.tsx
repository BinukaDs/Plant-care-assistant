                ...
                <div className='relative bg-card rounded-xl h-full p-10 w-full mb-12'>
                  ...
                  <div className='flex justify-start mx-5 w-full'>
                    <div className='flex flex-col justify-start text-start mx-5'>
                      ...
                      <p className='text-secondary mt-2'><ReactMarkdown>{PlantData.speciesData.description}</ReactMarkdown></p>
                    </div>
                  </div>
                </div>
            }
            ...
            <div className='flex flex-row h-full  gap-6'>
              ...
              <div className='bg-card rounded-xl flex flex-col w-full basis-1/2 h-full p-10'>
                <div className='flex flex-col w-full items-start justify-between mb-3'>
                  ...
                  <p className='text-xs flex items-start justify-start gap-x-1 text-secondary'>Generated By <img src="../../Gemini.png" alt="Gemini logo"  width={"35px"} height={"10px"}/></p>
                </div>
                
                {isLoading ?  <CareGuideSkeleton /> : <p className='text-start'><ReactMarkdown>{PlantData.speciesData.careGuide}</ReactMarkdown></p>}
              </div> 
            </div>
          </div>
        </section>
